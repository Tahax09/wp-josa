...
<div class="row">
  <form class="" method="post" action="" id="pm_regform_<?php echo $gid; ?>" name="pm_regform_<?php echo $gid; ?>" onsubmit="return profile_magic_frontend_validation(this)" enctype="multipart/form-data">
    <?php
    ...
    <div class="">
      ...
      */
      ...
      <button type="submit" class="btn btn-primary"><?php _e('Submit','profile-magic');?></button>
    </div>
  </form>
</div>
<?php endif;?>
